...
export default function Checkout() {
  ...
  <div className="container mb-3 checkout-page" style={{marginTop:'86px'}}>
    ...
    <h4 className="text-center">Your cart is empty</h4>
      ...
      <button className="btn btn-success btn  py-1 px-3 mx-2" onClick={() => increaseQuantity(product)}>+</button>
      {product.quantity}
      <button className="btn btn-danger btn py-1 px-3 mx-2" onClick={() => decreaseQuantity(product)}>-</button>
      </Card.Text>
      </div>
      </div>
      </Card.Body>
